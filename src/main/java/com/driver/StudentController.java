...
//    done
    ...
    public ResponseEntity<Teacher> getTeacherByName(@PathVariable String name){
        // Assign student by calling service layer method
        return new ResponseEntity<>( studentService.getTeacherByName(name), HttpStatus.CREATED);
    }
//   done
    @GetMapping("/get-students-by-teacher-name/{teacher}")
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        List<String> students = studentService.getStudentsByTeachersName(teacher); // Assign list of student by calling service layer method
